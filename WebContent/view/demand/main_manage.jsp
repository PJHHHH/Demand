...
<script id="a" type="text/javascript">
	...
	$.post(
		"/Demand/view/demand/get_main_page",
		{username:username},
		function(data){
...
<script type="text/javascript">
	...
	function currentPage(currentPage){
		...
		$.post(
			"/Demand/view/demand/do_main_search",
			json,
			function(data){
				$('tbody').empty();
				for(var i=0;i<data.length;i++){
					...
					+data[i].fix+"</td><td class='link-item'><a href='/Demand/view/demand/do_main_select?id="+data[i].id+"'>"
					+"查看"+"</a></td></tr>";
					$("tbody").append(table);
				}
			},
