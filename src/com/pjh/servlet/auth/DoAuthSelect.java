...
/**
 * Servlet implementation class DoAuthSelect
 */
@WebServlet("/view/demand/do_auth_select")
public class DoAuthSelect extends HttpServlet {
	/**
...
//		}
		...
		int count = 5;
		ArrayList<USER> mList = MainDao.searchUserManage(cpage, count, sql);
