 ...
 */
@WebServlet("/view/demand/do_check_update")
public class DoCheckUpdate extends HttpServlet {
	/**
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("check_update.jsp").forward(request, response);
	}
